...
function GestionEmpleados() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow container mx-auto p-6 pt-28 flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                <label className="mb-2 font-medium text-gray-700">Nombres</label>
                <input
                  type="text"
                  name="nombres"
              ...
              <div className="flex flex-col">
                <label className="mb-2 font-medium text-gray-700">Apellidos</label>
                <input
                  type="text"
                  name="apellidos"
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse">
              <thead className="bg-gray-200">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Nombres</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Apellidos</th>
